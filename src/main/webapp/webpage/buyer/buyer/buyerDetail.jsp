...
<head>
    ...
    <script type="text/javascript" src="/webpage/buyer/buyer/buyerDetail.js"></script>
</head>
                            ...
                            <div class="jumbotron">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <span class="control-label" data-bind="text:zfbAccount"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <span class="control-label" data-bind="text:weChatAccount"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <span class="control-label" data-bind="text:paypalAccount"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <select class="control-label" disabled data-bind="value:defaultPaymentAccount">
