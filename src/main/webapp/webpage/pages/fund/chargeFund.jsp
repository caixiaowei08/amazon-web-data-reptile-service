            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form action="/userFundController/doAlipayTradePagePay.do" target="_parent" id="formObj">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                               <div class="text-right" style="width: 100px;">折合人民币金额</div>
                                            </span>
                                            <input type="number" readonly="readonly" data-bind="value: chargeFundRMB" type="text" class="form-control"
                                                   data-bind="value:chargeFundRMB"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-2 col-md-offset-8">
                                                <input type="submit" class="btn btn-primary" value="立即充值">
                                            </div>
                                        </div>
                                    </div>
                                </form>
