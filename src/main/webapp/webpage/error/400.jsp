...
<head>
    ...
    <link rel="stylesheet" href="/webpage/error/error.css"/>
    <!--[if lte IE 9]>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="thumbnail">
                    <div class="jumbotron">
                        <h1>400！</h1>
                        <p>您的每一个产品，我们会把产品展示给数以万计的买家，供他们挑选，购买，评价并分享。返现是在线下操作，安全无痕迹。</p>
                        <p><a class="btn btn-primary btn-lg" href="/mainController.do?index" role="button">返回主页</a></p>
                    </div>
                </div>
            </div>
        </div>
